...
class Impulse(WaveRule):
    ...
    def set_conditions(self):
        ...
        conditions = {# WAVE 2
                      ...
                      'w4_2': {'waves': ['wave2', 'wave4'],
                                 'function': lambda wave2, wave4: wave4.length > wave2.length / 3.,
    ...
    def set_conditions(self):
        ...
        conditions = {# WAVE 2
                     'w2_0': {'waves': ['wave1', 'wave2', 'wave3', 'wave4'],
                              'function': lambda wave1, wave2, wave3, wave4: self.slope(wave2.idx_end, wave4.idx_end, wave2.low, wave4.low) >
                                                                             self.slope(wave1.idx_end, wave3.idx_end, wave1.high, wave3.high) and
                                                                             self.slope(wave1.idx_end, wave3.idx_end, wave1.high, wave3.high) > 0,
